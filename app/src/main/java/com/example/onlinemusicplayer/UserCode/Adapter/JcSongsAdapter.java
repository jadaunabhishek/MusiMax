...
import com.example.onlinemusicplayer.UserCode.ClassJavaUser.GetSongs;
import com.example.onlinemusicplayer.UserCode.ClassJavaUser.Utility;
...
public class JcSongsAdapter  extends RecyclerView.Adapter<JcSongsAdapter.SongsAdapterViewHolder> {
    ...
    public SongsAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.user_songs_row,parent,false);
