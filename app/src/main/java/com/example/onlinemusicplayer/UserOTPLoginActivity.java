...
import com.example.onlinemusicplayer.utils.AndroidUtil;
...
public class UserOTPLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_otp_login);
        ...
        editNumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(UserOTPLoginActivity.this, UserPhoneLoginActivity.class));
            }
        });
        ...
        mAuth.signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Intent intent = new Intent(UserOTPLoginActivity.this, UserMainScreen.class);
